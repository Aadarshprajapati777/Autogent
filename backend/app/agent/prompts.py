"""PM intelligence prompts — ported from CloseLoopAI's kgmemory service.

These are the rich, domain-specific prompts that make the agent behave like
a real project manager instead of a generic chatbot. Each prompt is a template
string formatted with context at call time.

Categories:
  - Extraction: FACT_EXTRACTION_PROMPT
  - Retrieval: QUERY_INTENT_PROMPT, ASSOCIATIVE_RANKING_PROMPT
  - Reporting: REPORT_PROMPT, FOUNDER_DIGEST_PROMPT, MEETING_SUMMARY_PROMPT
  - State inference: PROJECT_STATE_PROMPT, PERSON_STATE_PROMPT
  - PM reasoning: PM_DECISION_PROMPT, CHECKIN_PROMPT
  - Onboarding: ENGINEER_ONBOARDING_PROMPT, PROJECT_INTAKE_PROMPT
  - Work review: WORK_REVIEW_PROMPT, NEXT_STEPS_PROMPT
  - Planning: SPRINT_PLANNING_PROMPT, RETROSPECTIVE_PROMPT, SCOPE_CREEP_PROMPT
  - Team: PERFORMANCE_FEEDBACK_PROMPT, MORALE_SENSING_PROMPT
  - Stakeholders: STAKEHOLDER_UPDATE_PROMPT
"""
